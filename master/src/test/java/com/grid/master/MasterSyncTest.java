...
// prepare simulation parameters
        ...
        System.out.println("-----------------------------Start the Synch Submiting-----------------------------");
        SimulationResult ress =(SimulationResult)master.submitTaskSync(params) ;
        System.out.println("[Test] Final result: ");
        System.out.println("Total jams: " + ress.getTotalJamsDetected());
        System.out.println("Average speed: " + ress.getAverageSpeed());
        System.out.println("Congestion map: " + ress.getCongestionMap());
    }
}
