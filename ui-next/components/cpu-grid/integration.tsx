    ...
    const observer = new IntersectionObserver(
      (entries) => {
        ...
        const cards = Array.from(
          root.querySelectorAll<HTMLElement>('[data-integration="card"]')
        );
        ...
        if (cards.length)
          tl.to(
            cards,
            { opacity: 1, y: 0, stagger: 0.12, clearProps: "transform" },
            header ? "-=0.25" : 0
          );
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div data-integration="header" className="text-center mb-16">
          ...
          <p className="text-xl text-slate-500 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed">
            A clear separation between control and compute in a distributed
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div
            data-integration="card"
            className="
              group relative rounded-3xl border border-white/60 dark:border-[rgb(var(--border)/var(--glass-border-alpha))] bg-white/70 dark:bg-[rgb(var(--glass)/var(--glass-alpha))] backdrop-blur-xl
              shadow-[0_24px_70px_-45px_rgba(15,23,42,0.35)] dark:shadow-[0_24px_70px_-45px_rgba(0,0,0,0.55)]
          ...
          >
            <div className="flex items-start gap-5">
              <div className="relative shrink-0">
                ...
                <div className="relative flex size-14 items-center justify-center rounded-2xl bg-white/80 dark:bg-[rgb(var(--glass)/0.65)] ring-1 ring-white/70 dark:ring-white/10 shadow-[0_18px_55px_-44px_rgba(15,23,42,0.25)] dark:shadow-[0_18px_55px_-44px_rgba(0,0,0,0.55)]">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-3">
                  ...
                  <span className="inline-flex items-center rounded-full border border-white/70 dark:border-white/10 bg-white/80 dark:bg-[rgb(var(--glass)/0.65)] px-3 py-1 text-xs font-semibold text-slate-600 dark:text-slate-300">
                    Spring Boot
                  </span>
                </div>

                <p className="mt-3 text-slate-600 dark:text-slate-300 leading-relaxed">
                  CPU Grid exposes a REST-based control plane that allows
                  clients to:
                </p>
                ...
                <p className="mt-6 text-slate-600 dark:text-slate-300 leading-relaxed">
                  The Next.js web interface is one client of this API, but the
                  architecture allows future automation, scripting, or external
                  integrations.
                </p>

                <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-white/70 dark:border-white/10 bg-white/80 dark:bg-[rgb(var(--glass)/0.65)] px-4 py-2 text-xs font-semibold text-slate-600 dark:text-slate-300">
          ...
          >
            <div className="flex items-start gap-5">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-6 text-slate-600 dark:text-slate-300 leading-relaxed">
                  This model demonstrates a classic Master–Worker distributed
                  architecture, optimized for Monte Carlo workloads.
                </p>
              </div>
            </div>
          </div>
