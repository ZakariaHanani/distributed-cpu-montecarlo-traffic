...
echo [worker.bat] Project root: %ROOT_DIR%
...
if not exist "%ROOT_DIR%\worker\target\classes" (
    echo [ERROR] worker\target\classes not found.
...
echo [worker.bat] Starting Worker node...
